...
<style type="text/css">
    ...
    <?php }
        ...
        if(!empty($logo_typo)) printf(".site-logo .site-title{%s}", ot_check_font_css_prop($logo_typo));
        ...
        if(!empty($body_typo)){
            echo 'body, p, .section-content p, .post-content,.post-content p, .page-content, .page-content p, .cpt-excerpt, .cpt-excerpt p, .cpt-content, .cpt-content:not(.dashicons), .cpt-content p, .sidebar{'.
        ...
        if(!empty($h2_typo)){
            echo 'h2, .page-content h2, .post-content h2, cpt-content h2{'.
        ...
        if(!empty($h3_typo)){
            echo 'h3, .page-content h3, .post-content h3, cpt-content h3{'.
        ...
        /* Buttons - Font Style */
        $buttonsh_typo = ot_get_option('buttonsh_typo');
        ...
        if(!empty($footerh_typo)){
            echo '.footer-widgets, .footer-widgets p, .footer-widgets .widget p{'.
        ...
        if(!empty($body_css_val)) printf("#page{%s}", ot_check_bg_css_prop($body_css_val));
        ...
        $ont_buttons_text_color = ot_get_option('cont_buttons_text_color');
        if(!empty($ont_buttons_text_color)){
            ...
            echo '.cta-content .button:hover, .section-button .button:hover, .cpt-button .button:hover, .cpt-buttons .button:hover, #commentform input[type=submit]:hover {'.
